...
public class RxSchedulerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void start() {
        ...
        Observable.create(new Observable.OnSubscribe<Drawable>() {
            ...
            public void call(Subscriber<? super Drawable> subscriber) {
                ...
                Drawable dd = getResources().getDrawable(R.mipmap.img);
                ...
                .map(new Func1<Drawable, ImageView>() {
                    ...
                    public ImageView call(Drawable drawable) {
                        ...
                        ImageView img = new ImageView(RxSchedulerActivity.this);
